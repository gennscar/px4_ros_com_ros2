...
class Init_SensorGyroFft_peak_magnitude_z
{
public:
  explicit Init_SensorGyroFft_peak_magnitude_z(::px4_msgs::msg::SensorGyroFft & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::SensorGyroFft peak_magnitude_z(::px4_msgs::msg::SensorGyroFft::_peak_magnitude_z_type arg)
  {
    msg_.peak_magnitude_z = std::move(arg);
...
class Init_SensorGyroFft_peak_magnitude_y
{
public:
  explicit Init_SensorGyroFft_peak_magnitude_y(::px4_msgs::msg::SensorGyroFft & msg)
  : msg_(msg)
  {}
  Init_SensorGyroFft_peak_magnitude_z peak_magnitude_y(::px4_msgs::msg::SensorGyroFft::_peak_magnitude_y_type arg)
  {
    msg_.peak_magnitude_y = std::move(arg);
    return Init_SensorGyroFft_peak_magnitude_z(msg_);
  }
...
class Init_SensorGyroFft_peak_magnitude_x
{
public:
  explicit Init_SensorGyroFft_peak_magnitude_x(::px4_msgs::msg::SensorGyroFft & msg)
  : msg_(msg)
  {}
  Init_SensorGyroFft_peak_magnitude_y peak_magnitude_x(::px4_msgs::msg::SensorGyroFft::_peak_magnitude_x_type arg)
  {
    msg_.peak_magnitude_x = std::move(arg);
    return Init_SensorGyroFft_peak_magnitude_y(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_SensorGyroFft_peak_magnitude_x peak_frequencies_z(::px4_msgs::msg::SensorGyroFft::_peak_frequencies_z_type arg)
  {
    msg_.peak_frequencies_z = std::move(arg);
    return Init_SensorGyroFft_peak_magnitude_x(msg_);
  }
